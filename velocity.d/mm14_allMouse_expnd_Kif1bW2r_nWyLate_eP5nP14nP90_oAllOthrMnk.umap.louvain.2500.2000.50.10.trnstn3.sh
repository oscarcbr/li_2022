...
#SBATCH -n 8
#SBATCH -t 36:00:00
#SBATCH -J trnstn3.mm14_allMouse_expnd_Kif1bW2r_nWyLate_eP5nP14nP90_oAllOthrMnk.umap.louvain.2500.2000.50.10.velocity
#SBATCH -o trnstn3.mm14_allMouse_expnd_Kif1bW2r_nWyLate_eP5nP14nP90_oAllOthrMnk.umap.louvain.2500.2000.50.10.velocity.log
...
scPrfx='mm14_allMouse_expnd_Kif1bW2r_nWyLate_eP5nP14nP90_oAllOthrMnk.umap.louvain.2500.2000.50.10.velocity.trnstn3'
...
#Interest genes file
file_gene_interest='transition3.txt'
#Species
species='Mouse'
...
outFlPrfx='mm14_allMouse_expnd_Kif1bW2r_nWyLate_eP5nP14nP90_oAllOthrMnk_cnts.scnpy.depNmtchndrlRgrs_ccRgrssn.pca.data.trnstn3'
