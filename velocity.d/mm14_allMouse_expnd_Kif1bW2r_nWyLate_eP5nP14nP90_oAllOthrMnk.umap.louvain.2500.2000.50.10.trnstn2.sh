...
#SBATCH -n 8
#SBATCH -t 36:00:00
#SBATCH -J trnstn2.mm14_allMouse_expnd_Kif1bW2r_nWyLate_eP5nP14nP90_oAllOthrMnk.umap.louvain.2500.2000.50.10.velocity
#SBATCH -o trnstn2.mm14_allMouse_expnd_Kif1bW2r_nWyLate_eP5nP14nP90_oAllOthrMnk.umap.louvain.2500.2000.50.10.velocity.log
...
scPrfx='mm14_allMouse_expnd_Kif1bW2r_nWyLate_eP5nP14nP90_oAllOthrMnk.umap.louvain.2500.2000.50.10.velocity.trnstn2'
...
#Interest genes file
file_gene_interest='transition2.txt'
#Species
species='Mouse'
...
outFlPrfx='mm14_allMouse_expnd_Kif1bW2r_nWyLate_eP5nP14nP90_oAllOthrMnk_cnts.scnpy.depNmtchndrlRgrs_ccRgrssn.pca.data.trnstn2'
#Output folder to write adata merged file
outFldr='mm10_scanpy.d/mm14_allMouse_expnd_Kif1bW2r_nWyLate_eP5nP14nP90_oAllOthrMnk.d'
