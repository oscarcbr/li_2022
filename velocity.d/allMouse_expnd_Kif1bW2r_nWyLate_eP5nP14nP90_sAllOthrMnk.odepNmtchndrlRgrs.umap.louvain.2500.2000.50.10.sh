...
#SBATCH -n 8
#SBATCH -t 36:00:00
#SBATCH -J mm14_allMouse_expnd_Kif1bW2r_nWyLate_eP5nP14nP90_sAllOthrMnk.umap.louvain.2500.2000.50.10.velocity
#SBATCH -o mm14_allMouse_expnd_Kif1bW2r_nWyLate_eP5nP14nP90_sAllOthrMnk.umap.louvain.2500.2000.50.10.velocity.log
...
scPrfx='mm14_allMouse_expnd_Kif1bW2r_nWyLate_eP5nP14nP90_sAllOthrMnk.umap.louvain.2500.2000.50.10.velocity'
...
outFlPrfx='mm14_allMouse_expnd_Kif1bW2r_nWyLate_eP5nP14nP90_sAllOthrMnk_cnts.scnpy.depNmtchndrlRgrs_ccRgrssn.pca.data'
#Output folder to write adata merged file
outFldr='mm14_allMouse_expnd_Kif1bW2r_nWyLate_eP5nP14nP90_sAllOthrMnk.d'
#Embedding h5ad file or #'umap'
embdgNm='umap'
