...
#SBATCH -n 8
#SBATCH -t 36:00:00
#SBATCH -J trnstn6.mm14_allMouse_expnd_Kif1bW2r_nWyLate_eP5nP14nP90_sAllOthrMnk.umap.louvain.2500.2000.50.10.velocity
#SBATCH -o trnstn6.mm14_allMouse_expnd_Kif1bW2r_nWyLate_eP5nP14nP90_sAllOthrMnk.umap.louvain.2500.2000.50.10.velocity.log
...
scPrfx='mm14_allMouse_expnd_Kif1bW2r_nWyLate_eP5nP14nP90_sAllOthrMnk.umap.louvain.2500.2000.50.10.velocity.trnstn6'
...
#Interest genes file
file_gene_interest='transition6.txt'
#Species
species='Mouse'
...
outFlPrfx='mm14_allMouse_expnd_Kif1bW2r_nWyLate_eP5nP14nP90_sAllOthrMnk_cnts.scnpy.depNmtchndrlRgrs_ccRgrssn.pca.data.trnstn6'
...
h5adEmbddngFl='mm14_allMouse_expnd_Kif1bW2r_nWyLate_eP5nP14nP90_sAllOthrMnk_cnts.scnpy.depNmtchndrlRgrs_ccRgrssn.pca.data.umap.louvain.h5ad'
#Ancestral gene
anctrlGn='Erbb3'
######################
