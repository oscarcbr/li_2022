...
#SBATCH -n 8
#SBATCH -t 36:00:00
#SBATCH -J trnstn5.mm14_allMouse_expnd_Kif1bW2r_nWyLate_eP5nP14nP90_sAllOthrMnk.umap.louvain.2500.2000.50.10.velocity
#SBATCH -o trnstn5.mm14_allMouse_expnd_Kif1bW2r_nWyLate_eP5nP14nP90_sAllOthrMnk.umap.louvain.2500.2000.50.10.velocity.log
...
mstrDBfls='mm14_allMouse_expnd_Kif1bW2r_nWyLate_eP5nP14nP90_sAllOthrMnk.mstrDB.tsv'
...
#Output loom merge
outLoomMrgd='mm14_allMouse_expnd_Kif1bW2r_nWyLate_eP5nP14nP90_sAllOthrMnk.mrgd.loom'
#Prefix for the project
scPrfx='mm14_allMouse_expnd_Kif1bW2r_nWyLate_eP5nP14nP90_sAllOthrMnk.umap.louvain.2500.2000.50.10.velocity.trnstn5'
...
#Interest genes file
file_gene_interest='transition5.txt'
#Species
species='Mouse'
#Input counts h5ad file
cntsFl='allMouse_expnd_Kif1bW2r_nWyLate_eP5nP14nP90_sAllOthrMnk_cnts.h5ad'
#Input embedding h5ad file
emdngFl='allMouse_expnd_Kif1bW2r_nWyLate_eP5nP14nP90_sAllOthrMnk_scnpy.depNmtchndrlRgrs_ccRgrssn.pca.data.louvain_n_leiden.h5ad'
#Output prefix h5ad file with adata to plot
outFlPrfx='mm14_allMouse_expnd_Kif1bW2r_nWyLate_eP5nP14nP90_sAllOthrMnk_cnts.scnpy.depNmtchndrlRgrs_ccRgrssn.pca.data.trnstn5'
#Output folder to write adata merged file
outFldr='mm14_allMouse_expnd_Kif1bW2r_nWyLate_eP5nP14nP90_sAllOthrMnk.d'
#Input embedding h5ad file or #'umap'
embdgNm='umap'
#Cluster name in the embedding file, or #louvain 
clstrNm='louvain'
#Ouput h5ad from counts and embedding files
h5adEmbddngFl='mm14_mm14_allMouse_expnd_Kif1bW2r_nWyLate_eP5nP14nP90_sAllOthrMnk_cnts.scnpy.depNmtchndrlRgrs_ccRgrssn.pca.data.umap.louvain.h5ad'
#Ancestral gene
anctrlGn='Erbb3'
######################
